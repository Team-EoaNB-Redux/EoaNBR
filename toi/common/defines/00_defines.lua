NDefines = {
	...
	NDiplomacy = {
		...
		BASE_IMPROVE_RELATION_COST = 15,                -- Political power cost to initiate relation improvement
	...
	NAI = {
		...
		MAX_DISTANCE_NAVAL_INVASION = 2000.0,				-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
