...
NDefines.NDiplomacy.EQUIPMENT_PURCHASE_ACCEPTANCE_TRADE_INFLUENCE = 0.00 -- Acceptance factor for trade influence (adjusted from base value)
...
NDefines.NProduction.BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 50	-- vanilla 50  -- Base max efficiency for factories expressed in %.
